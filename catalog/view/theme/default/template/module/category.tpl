<div class="list-group">
  ...
  <a href="<?php echo $category['href']; ?>" class="<?php echo $categoria; ?> list-group-item active"><?php echo $category['name']; ?></a>
  ...
  <?php } ?>
  <?php } else { ?>
  <a href="<?php echo $category['href']; ?>" class="<?php echo $categoria; ?> list-group-item"><?php echo $category['name']; ?></a>
  <?php } ?>
  <?php } ?>
</div>
