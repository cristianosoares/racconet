...
<br />
  ...
  <?php } ?>
   ...
   <tr>
     <td align="center">
<a class="btn btn-primary" onclick="email_subscribeslr()"><span><?php echo $entry_button; ?></span></a><?php if($option_unsubscribe) { ?>
          <a class="btn btn-primary" onclick="email_unsubscribeslr()" ><span><?php echo $entry_unbutton; ?></span></a>
      <?php } ?>    
