...
<?php setcookie("newssub","newssub", time()+3600*24*7); ?>
  <?php endif; ?>

<script type="text/javascript">jQuery(document).ready(function() {
if ($.cookie('newssub') != 'newssub'){ 
