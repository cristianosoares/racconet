...
<a href="#subscribeformthickbox" title="" class="fancyboxx"><?php echo($text_subscribe); ?> </a>
 
   </div>
</div>

<script type="text/javascript" src="catalog/view/javascript/jquery/fancybox/jquery.fancybox.pack.js">
</script><link rel="stylesheet" type="text/css" href="catalog/view/javascript/jquery/fancybox/jquery.fancybox.css" media="screen" />
...
$('.fancyboxx').fancybox({  'padding' : 0, 'scrolling'        : 'no', 'centerOnScroll': true,   'titleShow'        : false  });
...
$("#subscribeformthickbox").bind("submit", function() {
 ...
 <?php } ?>
        ...
        $('#subscribeformthickbox').before('<div class="alert ' + data.type + '">' + data.message + '</div>');
        $('div.' + data.type).delay(3000).slideUp(400, function(){if($(this).hasClass('alert-success')){$.fancybox.close();}$(this).remove();});
      } else {
