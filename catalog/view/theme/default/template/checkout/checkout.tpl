                ...
                $.ajax({
                    ...
                    success: function(html) {
						...
						$('#collapse-checkout-confirm').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_confirm; ?>');
                                                ...
                                                enviarOrcamento(); //chamada da funcao de envio de orcamento
                    },
                    error: function(xhr, ajaxOptions, thrownError) {
                        alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
                    }
...
// Shipping Address         
function metodoEnderecoPagamento() {
    $.ajax({
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
						...
						$('#collapse-payment-method').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_payment_method; ?>');
						$('#collapse-checkout-confirm').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_confirm; ?>');
                                                metodoEntrega(); //metodo definicao de entrega
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (shipping_address) {
                    $.ajax({
                        ...
                        success: function(html) {
							...
							$('#collapse-payment-method').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_payment_method; ?>');
							$('#collapse-checkout-confirm').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_confirm; ?>');
                                                        metodoEntrega(); // metodo definicao do frete
                        },
                        error: function(xhr, ajaxOptions, thrownError) {
                            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
                        }
			    ...
			    //$('a[href=\'#collapse-payment-method\']').trigger('click');
                            ...
                            enviarOrcamento();// metodo para enviar orcamento
                    },
                    error: function(xhr, ajaxOptions, thrownError) {
                        alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
                    }
