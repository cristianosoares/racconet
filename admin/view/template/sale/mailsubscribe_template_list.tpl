  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="submit" form="form-mailsubscribe-template" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></button>
        </div>
...
<div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="table-responsive">
	   <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-mailsubscribe-template">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($template['selected']) { ?>
                ...
                <?php } ?></td>
                <td class="left"><?php echo $template['template_id']; ?></td>
              <td class="left"><?php echo $template['name']; ?></td>
             
             
              <td class="left"><?php echo $template['date_modified']; ?></td>
