...
<a style="background:#cd0111; color:#ffffff !important; padding:8px 10px;text-decoration:none;font-size:13px;color:#fb3544;text-decoration:none;" href="<?php echo $product['href']; ?>">Buy NOw!</a>
</div>
              </td>
            </tr>
          </tbody>
