...
<table width="560" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td style="color:<?php echo $heading_color; ?>;<?php echo $heading_style; ?>" align="center" height="30px;"><?php echo $heading; ?></td>
            </tr>
          </tbody>
...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      ...
      <?php if ($product) { ?>
      <td valign="top" style="vertical-align: top; border:1px #f0f0f0 solid;width:168px;text-align:center;">
        <table border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;text-align:center;">
          <tbody>
            ...
            <tr>
              <td style="padding:8px 6px 20px 6px; width:150px; font-family:Arial, Helvetica, sans-serif; font-size:11px; vertical-align: top;">
              <a style="color:<?php echo $name_color; ?>;<?php echo $name_style; ?>" href="<?php echo $product['href']; ?>" target="_blank"><?php echo $product['name']; ?></a> 
                ...
                <?php if ($show_price) { ?>
                  <?php if (isset($product['special']) && $product['special']) { ?>
                    <span style="color:<?php echo $price_color; ?>; font-size: 16px;<?php echo $special_style; ?>"><?php echo $product['special']; ?></span><br>
                    <span style="color:<?php echo $special_color; ?>;  font-size: 16px; <?php echo $price_style; ?>"><s><?php echo $product['price']; ?></s></span>
                  <?php } else { ?>
                    <span style="color:<?php echo $price_color; ?>;  font-size: 16px;<?php echo $price_style; ?>"><?php echo $product['price']; ?></span>
                  <?php } ?>
                <?php } ?>
				<br >
...
<a style="background:#cd0111; color:#ffffff; padding:8px 10px;text-decoration:none;font-size:13px;" href="<?php echo $product['href']; ?>">Buy NOw!</a>
</div>
              </td>
            </tr>
          </tbody>
