...
<table style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="560" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="20"></td>
            </tr>
  
            <tr>
              <td style="color:<?php echo $heading_color; ?>;<?php echo $heading_style; ?>; font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:160%;font-weight:bold;"><?php echo $heading; ?></td>
            </tr>
          </tbody>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" style="border:1px #f0f0f0 solid;width:168px;text-align:center;">
        <table style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;text-align:center;">
          <tbody>
            <tr>
            ...
            <tr>
              ...
              <a style="text-decoration:none; font-size: 13px; font-weight: bold; color:<?php echo $name_color; ?>;<?php echo $name_style; ?>" href="<?php echo $product['href']; ?>" target="_blank"><?php echo $product['name']; ?></a> 
                <br>
                ...
                <?php if ($show_price) { ?>
                  <?php if (isset($product['special']) && $product['special']) { ?>
                    ...
                    <span style="color:<?php echo $price_color; ?>;<?php echo $price_style; ?>"><s><?php echo $product['price']; ?></s></span>
                  <?php } else { ?>
...
<a style="background:#cd0111; color:#fff; padding:8px 10px;text-decoration:none;font-size:13px;text-decoration:none;" href="<?php echo $product['href']; ?>">Buy NOw!</a>
</div>
              </td>
            </tr>
          </tbody>
