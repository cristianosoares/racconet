...
<title>Racconet</title>

<meta name="description" content="Racconet">
...
Obs.: Entende-se como indelével, técnica de gravação cujo caracteres permaneçam legíveis por todo o tempo de vida útil do equipamento.<br></p> 
    ...
    <div class="row certificados-container">
    	<div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-inmetro.png" alt="Certificado Inmetro"><br>
			<p>Inmetro</p>
        </div><!--col-md-3 certificados-single-->
        <div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-underwriters.png" alt="Certificado Underwriters Laboratory"><br>
			<p>Underwriters Laboratory</p>
        </div><!--col-md-3 certificados-single-->
        <div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-mine-safety.png" alt="Certificado Mine Safety Health Administration"><br>
			<p>Mine Safety Health<br>Administration</p>
        </div><!--col-md-3 certificados-single-->
        <div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-factory-mutal.png" alt="Certificado Factory Mutual"><br>
			<p>Factory Mutual</p>
        </div><!--col-md-3 certificados-single-->
    ...
    <div class="row certificados-container">
    	<div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-atex.png" alt="Certificado ATEX Europe"><br>
			<p>ATEX Europe</p>
        </div><!--col-md-3 certificados-single-->
        <div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-aus.png" alt="Certificado Australian Board of Approvals"><br>
			<p>Australian Board of<br>Approvals</p>
        </div><!--col-md-3 certificados-single-->
        <div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-iecex.png" alt="Certificado International Electrotechnical Commission System"><br>
			<p>International Electrotechnical<br>Commission System</p>
        </div><!--col-md-3 certificados-single-->
        <div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-etl.png" alt="Certificado ETL"><br>
			<p>ETL</p>
        </div><!--col-md-3 certificados-single-->
    </div><!--row certificados-container-->
    ...
    <div class="row certificados-container">
    	<div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-sgs.png" alt="Certificado SGS U.S. Testing CO."><br>
			<p>SGS U.S. Testing CO.</p>
        </div><!--col-md-3 certificados-single-->
        <div class="col-md-3 col-sm-4 col-xs-6 certificados-single">
        	<img src="images/certificado-qps.png" alt="Certificado QPS Evaluation Services"><br>
...
<div id="areas" class="container" style="display:none">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <img src="images/areas-exemplo.png" alt="Áreas Exemplo">
...
<div id="lanternas" class="container" style="display:none">
	<div class="row">
    	<div class="col-md-6 col-sm-6 col-xs-12">
        	<img class="center-block" src="images/lanternas-exemplo.png" alt="Lanternas Exemplo">
        </div><!--col-md-6-->
...
Se o H2 se acumular nas pilhas ou em seus compartimentos, sem que haja o devido "alívio", a pressão interna sobe, causando ruptura do invólucro. Além disso, misturas de H2 e Oxigênio (O²) são altamente explosivas. Essas misturas, na presença de faíscas ou excesso de calor, podem causar explosões poderosas.</p>
    ...
    <div class="row">
        ...
        <div class="col-md-7 col-md-offset-1 col-sm-6 col-xs-12">
        	<img class="center-block" src="images/lanternas-descricao.png" alt="Lanternas Descrição">
        </div><!--col-md-8-->
    </div><!--row-->
    ...
    <div class="row">    	
        ...
        <div class="col-md-6 col-md-pull-6 col-sm-6 col-sm-pull-6 ">
        	<img class="center-block"src="images/lanternas-interno.png" alt="Lanterna interno">
        </div><!--col-md-6-->
    </div><!--row-->
    ...
    <div class="row">    	
        ...
        <div class="col-md-6 col-md-pull-6 col-sm-6 col-sm-pull-6 ">
        	<img class="center-block"src="images/lanternas-exemplo2.png" alt="Lanterna exemplo 2">
        </div><!--col-md-6-->
    </div><!--row-->
</div><!--lanternas-->
...
<div id="tipos-lampadas" class="container" style="display:none">
    ...
    <div class="row">
    	<div class="col-md-4 col-sm-5 col-xs-6">
        	<img src="images/lanterna-vb3.png" alt="Lanterna VB3 LED"><br>
        ...
        <div class="col-md-4 col-sm-5 col-xs-6">
        	<img src="images/lanterna-m6.png" alt="Lanterna M6 - Xenon"><br>
            <h3>Lanterna M6 - Xenon</h3><br>
            <p>&bull; 74 Lumens<br>&bull; 1 hora de uso contínuo</p>
        </div><!--col-md-4-->
        
        <div class="col-md-4 col-sm-2 col-xs-6 ">
        	<img src="images/lanterna-lumens.png" alt="Forças opostas: Autonomia X Luminosidade"><br>
            <h3>Forças opostas:
